...
//								pointCloud.SetActive (false);
      ...
      // grabs map position data loaded previously after login and prepares to spawn
      ...
      //using the hitcube point, then goes through the mapdata in a 2D grid, spawning units as needed based
      //on their identifier
    ...
    //these methods prep the units for placement on the AR plane, setting their position to the 
    //appropriate coordinates, along with where they look and are angled
